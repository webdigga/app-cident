...
<p>In this section you can upload a photo of the accident from your mobile.  The file cannot exceed 10mb.  Multiple imagfes can be uploaded by clicking the 'plus' symbol.
...
<p>Your location and the current weather conditions should be automatically collected via the app, if we were unable to get htese details then we will ask you to fill out this information by selecting the weather conditions from the drop down and entering your location in the corresponding fields.  We will ask you for street name, city and country.</p>

<h4>FINALLY</h4>

<p>After ypu have submitted your form you will receive a success message which will give you your accident id.  Note this id down and reference this when you are back at the depot</p>
